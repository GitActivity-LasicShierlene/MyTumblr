...
//create a pre defined username and password snce we do not have database
$acc_username = "Shierlene";
$acc_password = "shienie123";
$acc_fullname = "Shierlene Marciano Lasic";
